        ...
        <section class="content">
            ...
            <ul>
                ...
                <li>
                    <h2>Salah (Gebed)</h2>
                    <p>
                        Salah, de tweede zuil, verwijst naar de rituele gebeden die moslims vijf keer per dag verrichten. Deze gebeden zijn een directe verbinding tussen de gelovige en Allah. De voorgeschreven tijden voor Salah zijn bij zonsopgang (Fajr), middag (Dhuhr), namiddag (Asr), zonsondergang (Maghrib) en avond (Isha). Elk gebed bestaat uit een reeks bewegingen en recitaties uit de Koran, bekend als Rak'ahs. Salah is verplicht voor alle volwassen moslims en dient als een constante herinnering aan de aanwezigheid van Allah in hun leven.
                    </p>
                </li>
                <li>
                    <h2>Zakat (Aalmoes)</h2>
                    <p>
                        Zakat, de derde zuil, is een vorm van aalmoes en sociale welzijn. Het vereist dat moslims een deel van hun rijkdom, meestal 2,5%, aan de behoeftigen geven. Deze praktijk zuivert iemands rijkdom en helpt om economische ongelijkheid binnen de moslimgemeenschap te verminderen.
                    </p>
                </li>
                <li>
                    <h2>Sawm (Vasten)</h2>
                    <p>
                        De vierde zuil, Sawm, houdt in dat er gedurende de maand Ramadan wordt gevast. Van zonsopgang tot zonsondergang onthouden moslims zich van eten, drinken, roken en huwelijksrelaties. Dit vasten is een middel tot geestelijke discipline, zelfbeheersing en empathie voor de minderbedeelden. Het culmineert in de viering van Eid al-Fitr, een feest dat het einde van de Ramadan markeert.
                    </p>
                </li>
                <li>
                    <h2>Hajj (Bedevaart)</h2>
                    <p>
                        De vijfde zuil, Hajj, is de bedevaart naar Mekka die elke moslim ten minste eenmaal in zijn leven moet ondernemen als hij fysiek en financieel in staat is. De bedevaart vindt plaats tijdens de islamitische maand Dhu al-Hijjah en omvat een reeks rituelen die in en rond Mekka worden uitgevoerd, ter herdenking van de daden van de profeet Abraham en zijn familie. Hajj symboliseert de eenheid van de islamitische ummah (gemeenschap) en hun onderwerping aan Allah.
                    </p>
                </li>
                <h2>Het belang van gebed (Salah)</h2>
                <p>
                    Van deze zuilen heeft Salah een speciale betekenis vanwege de frequentie en de intieme aard van de aanbidding. Het belang van gebed in de islam kan niet worden overschat. Het is een middel om een constante verbinding met Allah te onderhouden, leiding te zoeken en dankbaarheid te uiten. De fysieke handelingen die bij Salah betrokken zijn, zoals buigen en knielen, symboliseren de onderwerping en nederigheid van de aanbidder voor de Schepper.
                </p>
                <p>
                    Gebed speelt ook een cruciale rol in het bevorderen van een gemeenschapsgevoel onder moslims. De gemeenschappelijke gebeden, met name het vrijdaggebed (Jumu'ah), zijn gelegenheden voor moslims om samen te komen, sociale banden te versterken en een gedeeld gevoel van identiteit te behouden. Deze bijeenkomsten bieden mogelijkheden voor gemeenschappelijke ondersteuning en leren.
                </p>
                <p>
                    De tijden van de vijf dagelijkse gebeden zijn verspreid over de dag om ervoor te zorgen dat moslims regelmatig afstand nemen van hun dagelijkse activiteiten om Allah te gedenken. De discipline die nodig is om deze gebedstijden na te leven, bevordert een gevoel van mindfulness en verantwoordelijkheid. Het herinnert moslims eraan dat hun geloof niet beperkt is tot specifieke momenten, maar geïntegreerd is in hun hele leven.
                </p>
                <p>
                    De voordelen van Salah reiken verder dan het spirituele welzijn. De regelmatige fysieke bewegingen die bij de gebeden betrokken zijn, kunnen bijdragen aan de fysieke gezondheid, het bevorderen van flexibiliteit en de bloedsomloop. Bovendien kan de mentale focus en rust die tijdens Salah wordt bereikt, helpen stress en angst te verminderen, waardoor een gevoel van vrede en aarding ontstaat.
                </p>
                <p>
